...
export default function Single2() {
    ...
    let { id } = useParams()
    let dataCD = Coupond.find((a) => a.id == id)
                ...
                <div className="container py-4">
                    <div className='row  d-flex justify-content-between'>
                        ...
                        <div className='col-lg-3 p-0 '>
                            <img src={dataCD.image} alt='img' className='w-100 shadow p-1 bg-body rounded border border-2 p-0 ' />.
                        </div>
                        ...
                        <div className='col-lg-6 shadow p-3  bg-body rounded border border-2 mid mx-auto'>
                            ...
                            <div className=" border-top d-flex row border-bottom pb-2 pt-3 mt-1">
                                <div className=" col-lg-6 gap-4 d-flex justify-content-start ">
                                    ...
                                    <small className='rate1 py-2 px-3 mb-2'>- {dataCD.rating.rate}% off</small>
                                </div>

                                <div className="col-lg-6 d-flex justify-content-end">
                                    <h5 className='fw-bold  mt-2'>Stock: {dataCD.rating.count}</h5>
                                </div>
                            ...
                            <div className='py-3'>
                                ...
                                <p className="fw-bold py-3 text-danger">Rating: {dataCD.rating.rate}</p>
